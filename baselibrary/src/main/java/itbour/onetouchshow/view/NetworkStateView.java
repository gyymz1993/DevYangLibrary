...
public class NetworkStateView extends LinearLayout {
    ...
    public void showError() {
        ...
        if (null == mErrorView) {
            ...
            ImageView errorRefreshView = mErrorView.findViewById(R.id.refresh_view);
    ...
    public void showNoNetwork() {
        ...
        if (null == mNoNetworkView) {
            ...
            ImageView networkRefreshView = mNoNetworkView.findViewById(R.id.refresh_view);
    ...
    public void showEmpty(int resId, String mText) {
        ...
        if (null == mEmptyView) {
            ...
            ImageView emptyRefreshView = mEmptyView.findViewById(R.id.refresh_view);
