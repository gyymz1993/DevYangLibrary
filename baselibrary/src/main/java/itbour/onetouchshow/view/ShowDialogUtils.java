...
public class ShowDialogUtils {
    ...
    public ShowDialogUtils(final Context context, int style) {
        ...
        tv_loadText = mDialogContentView.findViewById(R.id.tv_loading_text);
        iv_loadImage = mDialogContentView.findViewById(R.id.iv_load_image);
        pb_loadProgress = mDialogContentView.findViewById(R.id.pb_load_progress);
        gvloadProgress = mDialogContentView.findViewById(R.id.gv_load_progress);
        // 设置Gif图片源
