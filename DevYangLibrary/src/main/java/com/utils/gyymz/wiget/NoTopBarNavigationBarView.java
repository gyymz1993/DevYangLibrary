 ...
 **/
public class NoTopBarNavigationBarView extends TranslucentNavBar {
    ...
    public NoTopBarNavigationBarView(Context context) {
        this(context, null);
    }

    public NoTopBarNavigationBarView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public NoTopBarNavigationBarView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    public NoTopBarNavigationBarView setTorBarTHeight(int height) {
     ...
     */
    public NoTopBarNavigationBarView setVisible(NavigationViewType navigationViewType, boolean visible) {
     ...
     * @return The BaseAdapterHelper for chaining.
     */
    public NoTopBarNavigationBarView setOnClickListener(NavigationViewType navigationViewType, OnClickListener listener) {
        View view = navigationViewID(navigationViewType);
     ...
     * @return The BaseAdapterHelper for chaining.
     */
    public NoTopBarNavigationBarView setText(NavigationViewType navigationViewType, String value) {
     ...
     * @return The BaseAdapterHelper for chaining.
     */
    public NoTopBarNavigationBarView setImageResource(NavigationViewType navigationViewType, int imageResId) {
     ...
     * @return The BaseAdapterHelper for chaining.
     */
    public NoTopBarNavigationBarView setBackgroundColor(NavigationViewType navigationViewType, int color) {
        View view = navigationViewID(navigationViewType);
     ...
     * @return The BaseAdapterHelper for chaining.
     */
    public NoTopBarNavigationBarView setBackgroundRes(NavigationViewType navigationViewType, int backgroundRes) {
        View view = navigationViewID(navigationViewType);
     ...
     * @return The BaseAdapterHelper for chaining.
     */
    public NoTopBarNavigationBarView setTextColor(NavigationViewType navigationViewType, int textColor) {
        TextView view = navigationViewID(navigationViewType);
     ...
     * @return The BaseAdapterHelper for chaining.
     */
    public NoTopBarNavigationBarView setTextColorRes(NavigationViewType navigationViewType, int textColorRes) {
        TextView view = navigationViewID(navigationViewType);
     ...
     * @return The BaseAdapterHelper for chaining.
     */
    public NoTopBarNavigationBarView setImageDrawable(NavigationViewType navigationViewType, Drawable drawable) {
        ImageView view = navigationViewID(navigationViewType);
